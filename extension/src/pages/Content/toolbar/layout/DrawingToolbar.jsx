...
const DrawingToolbar = (props) => {
    const [contentState, setContentState, timer, useTimer, historyLogs, setHistoryLogs] = useContext(contentStateContext);
    ...
    return (
        ...
        >
            ...
            <ToolTrigger
                ...
                onClick={() => undoCanvas(contentState, setContentState, [historyLogs, setHistoryLogs])}
            >
                <UndoIcon />
            </ToolTrigger>
            <ToolTrigger
                ...
                onClick={() => redoCanvas(contentState, setContentState, [historyLogs, setHistoryLogs])}
            >
                <RedoIcon />
            </ToolTrigger>
            <ToolTrigger
