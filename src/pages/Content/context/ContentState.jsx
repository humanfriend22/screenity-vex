...
const ContentState = (props) => {
    ...
    */
    ...
    useEffect(() => {
        chrome.storage.local.set({ historyLogs: historyLogs });
    }, [historyLogs]);
    ...
    return (
        ...
        <contentStateContext.Provider value={[contentState, setContentState, timer, setTimer, historyLogs, setHistoryLogs]}>
            {props.children}
